-- Create Silver Layer ETL Functions
-- This migration creates ETL functions for all Silver layer tables

-- ============================================================================
-- CREATE INDIVIDUAL ETL FUNCTIONS
-- ============================================================================
...
DROP FUNCTION IF EXISTS silver.process_all_tables();
...
BEGIN
  -- Process all tables
  FOR result IN
    SELECT 'shows' as table_name, * FROM silver.process_shows()
    UNION ALL
    SELECT 'setlists' as table_name, * FROM silver.process_setlists()
    UNION ALL
    SELECT 'venues' as table_name, * FROM silver.process_venues()
    UNION ALL
    SELECT 'latest' as table_name, * FROM silver.process_latest()
    UNION ALL
    SELECT 'metadata' as table_name, * FROM silver.process_metadata()
    UNION ALL
    SELECT 'links' as table_name, * FROM silver.process_links()
    UNION ALL
    SELECT 'uploads' as table_name, * FROM silver.process_uploads()
    UNION ALL
    SELECT 'appearances' as table_name, * FROM silver.process_appearances()
    UNION ALL
    SELECT 'jamcharts' as table_name, * FROM silver.process_jamcharts()
  LOOP
...
GRANT EXECUTE ON FUNCTION silver.process_shows() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_setlists() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_venues() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_latest() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_metadata() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_links() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_uploads() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_appearances() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_jamcharts() TO anon, authenticated;
GRANT EXECUTE ON FUNCTION silver.process_all_tables() TO anon, authenticated;

-- ============================================================================
-- COMMENTS
-- ============================================================================

COMMENT ON FUNCTION silver.process_shows() IS 'Process shows from bronze to silver layer';
COMMENT ON FUNCTION silver.process_setlists() IS 'Process setlists from bronze to silver layer';
COMMENT ON FUNCTION silver.process_venues() IS 'Process venues from bronze to silver layer';
COMMENT ON FUNCTION silver.process_latest() IS 'Process latest data from bronze to silver layer';
COMMENT ON FUNCTION silver.process_metadata() IS 'Process metadata from bronze to silver layer';
COMMENT ON FUNCTION silver.process_links() IS 'Process links from bronze to silver layer';
COMMENT ON FUNCTION silver.process_uploads() IS 'Process uploads from bronze to silver layer';
COMMENT ON FUNCTION silver.process_appearances() IS 'Process appearances from bronze to silver layer';
COMMENT ON FUNCTION silver.process_jamcharts() IS 'Process jamcharts from bronze to silver layer';
COMMENT ON FUNCTION silver.process_all_tables() IS 'Process all silver layer tables from bronze layer';
